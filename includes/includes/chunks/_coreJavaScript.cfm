...
<!--Core js-->
<!--- LOAD JQUERY HERE SO IT's available when you do inline  document ready type thigns.. --->
<script src="/js/jquery-1.10.2.min.js"></script>
<script src="/js/jquery-u	i/jquery-ui-1.10.1.custom.min.js"></script>
...
<!--- MAYBE SELECTIVE LOAD THIS JUNK ON A PAGE THAT NEEDS IT OTHER WISE DON"T LOAD IT ON EVERY PAGE!!! --->
<!---
