...
<head>
    ...
    <title>EcoFlex- Dynamic Data</title>
    ...
    <cfquery name="selInventoryData" datasource="db10">
        SELECT
    SKU, Description,Container, sum(Quantity) as eQuantity, DateRcvd
       FROM D8Ta 
       group by Container, SKU, Description, DateRcvd
    </cfquery>
    <!--- BLANK ARRAY for table data so we can loop query and push to this array. --->
    <cfset arTableData = []>

    <cfloop query="selInventoryData">
        <cfset stRow = {
            "SKU" = selInventoryData.sku,
            "Description" = selInventoryData.Description,
            "Container" = selInventoryData.Container,
            "Quantity" = selInventoryData.eQuantity,
            "DateRcvd" = selInventoryData.DateRcvd
        }>
        <cfset arrayAppend(arTableData, stRow)>
    </cfloop>
<body>
    <section id="container" >
        ...
        <header class="header fixed-top clearfix">
            ...
            <div class="brand">
                ...
                <a href="index.html" class="logo">
                    ...
                    <!--NICO SVG  <object data="../images/ECOFLEX.svg" type="image/svg+xml"></object>
                -->
        ...
        <div class="nav notify-row" id="top_menu">
            ...
            <ul class="nav top-menu">
                <!-- settings start -->
                <li class="dropdown">
                    <a data-toggle="dropdown" class="dropdown-toggle" href="#"> <i class="fa fa-tasks"></i>
                ...
                <li id="header_inbox_bar" class="dropdown">
                    ...
                    <ul class="dropdown-menu extended inbox">
                        ...
                        <li>
                            <a href="#">
                                <span class="photo">
                                    <img alt="avatar" src="images/avatar-mini.jpg"></span>
                                <span class="subject">
                        ...
                        <li>
                            <a href="#">
                                <span class="photo">
                                    <img alt="avatar" src="images/avatar-mini-2.jpg"></span>
                                <span class="subject">
                        ...
                        <li>
                            <a href="#">
                                <span class="photo">
                                    <img alt="avatar" src="images/avatar-mini-3.jpg"></span>
                                <span class="subject">
                                    <span class="from">Tasi sam</span>
                                    <span class="time">2 days ago</span>
                                </span>
                                <span class="message">This is an example msg.</span>
                            </a>
                        </li>
                        <li>
                            <a href="#">
                                ...
                                <span class="message">Hi there, its a test</span>
                            </a>
                        </li>
                        <li>
            ...
            <ul class="nav pull-right top-menu">
                ...
                <li class="dropdown">
                    <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                        ...
                        <span class="username">Default</span> <b class="caret"></b>
                    </a>
    ...
    <ul class="sidebar-menu" id="nav-accordion">
        ...
        <li class="sub-menu">
            <a href="javascript:;">
                ...
                <span>Receiving Audit</span>
            </a>
            <ul class="sub">
                <li>
                    <a href="boxed_page.html">Latest Audit</a>
                </li>
                <!-- <li>
                <a href="horizontal_menu.html">Horizontal Menu</a>
            </li>
            <li>
                <a href="language_switch.html">Language Switch Bar</a>
            </li>
            -->
        </ul>
    </li>
    <!--NICO  <li class="sub-menu">
    <a href="javascript:;">
...
-->
<li class="active">
<a href="dynamic_table.html">Current Inventory</a>
</li>
<!-- NICO USE FOR SHAWN ACCESS <li>
<a href="editable_table.html">Editable Table</a>
</li>
-->
</ul>
</li>
...
<ul class="sub">
<li>
<a href="form_component.html">Ship Order</a>
</li>
<!--   <li>
<a href="advanced_form.html">Advanced Components</a>
</li>
<li>
...
<li>
<a href="file_upload.html">Muliple File Upload</a>
</li>
...
<li>
<a href="mail_view.html">View Mail</a>
</li>
</ul>
</li>
<li class="sub-menu">
...
<li>
<a href="c3_chart.html">C3 Chart</a>
</li>
</ul>
</li>
<li class="sub-menu">
...
<div class="adv-table">
    <h4>TOTAL UNITS: <span id="xsum" ></span>   </h4>
...
<!--NICO ADDED COLDFUSION -->
<tbody>
<!--- <cfoutput>
<cfloop query="selInventoryData" >
    <!---NICO TRIED TO GROUP BUT DOESN'T ADD OTHER COLUMS UPgroup="Container"--->
    <tr class="gradeX">
        <td>#SKU#</td>
        <td>#Description#</td>
        <td>#Container#</td>
        <td class="rowDataSd">#equantity#</td>
        <td class="center hidden-date">#dateformat(DateRcvd,"m/d/y 'at' h:nn tt")#</td>
    </cfloop>
</cfoutput> --->
...
<a href="#">
<img src="images/avatar1_small.jpg" alt=""></a>
</div>
...
<div class="user-thumb">
<a href="#">
<img src="images/avatar1.jpg" alt=""></a>
</div>
<div class="user-details">
<h4>
...
<div class="user-thumb">
<a href="#">
<img src="images/chat-avatar2.jpg" alt=""></a>
</div>
<div class="user-details">
<h4>
<a href="#">Default</a>
...
<p>
<a href="#">Jim Doe</a>
Purchased new equipments for zonal office setup
</p>
</div>
</div>
<div class="prog-row">
...
<script>
     jQuery(function($){
        ...
        console.log(<cfoutput>#serializeJSON(arTableData)#</cfoutput>);
           var oTable = $('#dynamic-table').dataTable({
                "columns" : [
                      { data: "SKU" },
                    { data: "Description" },
                    { data: "Container" },
                    { data: "Quantity", className: "rowDataSd" },
                    { data: "DateRcvd" }
                ...
                footerCallback: function(row, data, start, end, display) {
                    ...
                    if (api.column( 3 ).data().length){
                        ...
                        $( api.column( 0 ).footer() ).html(
                            'Units on Hand: <span class="red">' + pageTotal + "</span>"
                        );
                    
                            $( api.column( 3 ).footer() ).html(
                            'Total Inventory: <span class="red">' + total + "</span>"
                        );
                            
                            document.getElementById("xsum").innerHTML = total;
                    }
                }
            });
  });
